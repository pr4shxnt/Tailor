    ...
    <>
      <section className="header-container h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="txtBox1 text-center z-50">
          ...
          <Link to="/shop" className="text-sm font-semibold border-solid border-2 rounded-md p-3 hover:bg-gray-400 transition-all duration-700 border-gray-400 hover:text-black bg-transparent text-gray-400">
            Shop Now
          </Link>
        </div>
      </section>
