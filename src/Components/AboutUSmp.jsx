...
const AboutUSmp = () => {
 // Set to true to show the Read More button
...
<div className="flex-box2 flex justify-center gap-36 align-center p-8">
  ...
  <div className="imgbox2">
    <img className='size-64 rounded-full' src="https://img.freepik.com/free-vector/teamwork-concept-landing-page_52683-20165.jpg" alt="" />
  </div>
</div>
...
<div className="imgbox">
  ...
  <div className="about-text-box2 w-2/5 text-right">
    <h1 className='font-semibold text-2xl '>
      Why us?
    </h1>
    <p>
  ...
  <div className="imgbox">
    <img className='size-64 rounded-full' src="https://pics.craiyon.com/2024-11-11/48YFEIGWTS6YRulV2C0mvg.webp" alt="" />
  </div>
</div>
