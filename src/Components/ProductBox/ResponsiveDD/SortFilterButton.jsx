 ...
 // Tracks the current sort state
  ...
  return (
    <div className=" top-[54px] z-20  w-full border-t border-tertiary lg:hidden fixed">
      ...
      <div
        ref={div1Ref}
        className={`fixed  bottom-0 left-1/2 transform -translate-x-1/2 w-full  bg-primary text-tertiary p-2 rounded-t-xl transition-transform duration-300 ease-in-out z-30 ${
      ...
      >
        ...
        <div className="max-h-[70vh] overflow-y-auto">
          <div className="flex flex-col justify-start items-start">
            ...
            <div className="w-full border-tertiary border-t rounded-t-xl">
              <button
                onClick={closeDiv}
                className="bg-tertiary text-primary rounded-xl p-2 w-full btn-small"
              >
                Done
              </button>
            </div>
      ...
      <div
        ref={div2Ref}
        className={`fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full  bg-primary rounded-t-xl transition-transform duration-300 ease-in-out z-30 ${
          isDiv2Visible ? "translate-y-0" : "translate-y-full"
        }`}
        style={{ display: isDiv2Visible ? "block" : "none" }}
      >
        <div className="flex justify-between items-center p-3 border-b-2 border-second-primary">
