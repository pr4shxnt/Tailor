...
const LoginModel = ({setLoginModel, LoginModel}) => {
  ...
  return (
    <div>
        ...
        <div className="fixed text-black z-[999] top-0 right-16 pt-20" onClick={()=> {setLoginModel(false)}}><X/></div>
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-10 z-50">
